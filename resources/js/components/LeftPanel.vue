<template>
	<div class="side-panel-container h-100">
		<div class="featured-card shadow-sm mb-3">
			...
			<div class="card-body p-3 pt-4">
				...
				<p class="khmer-font description-text text-muted mb-3">
		...
		<div class="calendar-card shadow-sm bg-white p-3">
			...
			<div class="calendar-grid">
				...
				<div v-for="date in daysInMonth" :key="date" class="grid-cell" :class="getSpecialDateClass(date)">
					{{ date }}
